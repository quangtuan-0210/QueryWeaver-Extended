...
def create_graphiti_client(falkor_driver: FalkorDriver) -> Graphiti:
    ...
    if Config.AZURE_FLAG:
        ...
        graphiti_llm_model = os.getenv("GRAPHITI_LLM_MODEL", "gemini/gemini-2.5-flash").replace("gemini/", "")
        graphiti_embedding_model = extract_embedding_model_name(Config.EMBEDDING_MODEL_NAME)
